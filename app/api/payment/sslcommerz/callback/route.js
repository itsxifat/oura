 ...
 * POST body: val_id, tran_id (our pendingId), amount, currency, etc.
 */
...
export async function POST(request) {
  ...
  try {
    ...
    const pendingId = formData.get('tran_id');   // we passed pendingId as tran_id
    ...
    return NextResponse.redirect(`${siteUrl}/payment/success?orderId=${encodeURIComponent(result.orderId)}&gateway=sslcommerz`);
  } catch (error) {
